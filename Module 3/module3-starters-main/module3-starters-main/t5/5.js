...
document.addEventListener("DOMContentLoaded", function () {
    //to get the element with id "pictures"
...
//loop through the picArray
    for (var i = 0; i < picArray.length; i++) {
        ...
        //appending child elements to the <figure> element
        figureElement.appendChild(imgElement);
        figureElement.appendChild(figcaptionElement);

        //appending child elements to the <article> element
        articleElement.appendChild(h2Element);
        articleElement.appendChild(figureElement);
        articleElement.appendChild(pElement);

        //appending the <article> element to the section with id "pictures"
